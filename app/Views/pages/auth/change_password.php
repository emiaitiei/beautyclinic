    ...
    <form method="post" action="/change-password" id="changePasswordForm">
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="password" name="new_password" class="form-control" id="new_password" required oninput="checkPasswordStrength()">
            </div>
        ...
        <div class="d-grid">
            <button type="submit" class="btn btn-primary" id="submitBtn" disabled>Ganti</button>
        </div>
    </form>
