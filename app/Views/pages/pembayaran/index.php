...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        ...
        <div class="ms-md-auto py-2 py-md-0">
            <a href="<?= base_url('/pembayaran/create') ?>" class="btn btn-primary btn-round">Tambah Data Pembayaran</a>
            <?php if (session()->get('level') == "2"): ?>
            <a href="/pembayaran/trash" class="btn btn-label-danger btn-round">Riwayat Hapus</a>
            <?php endif; ?>
        </div>
    </div>
                                ...
                                <?php $ms=1; foreach ($pembayarans as $pembayaran): ?>
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      <a href="<?= base_url('/pembayaran/edit/' . $pembayaran['id_pembayaran']) ?>" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                      </a>
                                      <form action="<?= site_url('pembayaran/delete/' . $pembayaran['id_pembayaran']) ?>" method="post" class="d-inline" onsubmit="return confirm(' Yakin ingin menghapus Data Pembayaran ini?')">
                                          <?= csrf_field() ?>
