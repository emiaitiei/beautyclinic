...
<div class="page-inner">
  <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
    <div>
      <h3 class="fw-bold mb-3">Laporan Booking</h3>
    </div>
  </div>
      ...
      <div class="col-lg-6 mb-3">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?= base_url('/laporan_booking/printlaporanbooking') ?>" method="POST">
              <?= csrf_field() ?>
      ...
      <div class="col-lg-6 mb-3">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?= base_url('/laporan_booking/pdflaporanbooking') ?>" method="POST">
              <?= csrf_field() ?>
