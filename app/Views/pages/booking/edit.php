...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Edit Data Booking</h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('booking/update/' . $booking['id_booking']) ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                          ...
                          <select name="id_pasien" id="id_pasien" class="form-control" required>
                            <option value="">-- Pilih --</option>
                              ...
                              <option value="<?= $pasien['id_pasien'] ?>" <?= $booking['id_pasien'] == $pasien['id_pasien'] ? 'selected' : '' ?>>
                                  <?= esc($pasien['nama_pasien']) ?>
                              </option>
                              <?php endforeach; ?>
                          </select>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <select name="id_dokter" id="id_dokter" class="form-control" required>
                            <option value="">-- Pilih --</option>
                              ...
                              <option value="<?= $dokter['id_dokter'] ?>" <?= $booking['id_dokter'] == $dokter['id_dokter'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                          ...
                          <select name="id_layanan" id="id_layanan" class="form-control" required>
                            <option value="">-- Pilih --</option>
                              ...
                              <option value="<?= $layanan['id_layanan'] ?>" <?= $booking['id_layanan'] == $layanan['id_layanan'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="datetime-local" name="waktu_booking" id="waktu_booking" class="form-control" value="<?= $booking['waktu_booking'] ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <textarea type="text" name="catatan" id="catatan" class="form-control" value="<?= $booking['catatan'] ?>" rows="4" required></textarea>
                        </div>
